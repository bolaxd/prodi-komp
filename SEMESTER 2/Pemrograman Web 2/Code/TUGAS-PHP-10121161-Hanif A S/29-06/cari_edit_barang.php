...
<body>
    <center>
    <h1>Pencarian edit data barang</h1>
    <hr>
    <div class="col-sm-4">
        ...
        <table class="table">
            ...
            while ($listBarang = mysqli_fetch_row($hasilTampil)) {
                ...
                echo "<tr>
                        ...
                        <tr>
                        <td>NAMA BARANG</td>
                        <td><input class='form-control' type='text' name='namabarang' value='$namabarang'></td>
                    </tr>
                    <tr>
                        <td>HARGA</td>
                        <td><input class='form-control' type='text' name='harga' value='$harga'></td>
                    </tr>
                    <tr>
                        <td>STOK</td>
